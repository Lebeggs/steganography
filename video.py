...
def encode_video(video_filename, message_filename, output_file_path):
...
def main():
    ...
    encode_video(video_filename, message_filename, output_file_path)
    print("Encoding completed and saved to", output_file_path)

    # Test decoding
    print("\nDecoding process started...\n")
    decoded_message = decode_video(output_file_path)
